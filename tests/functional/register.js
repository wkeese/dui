define([
	...
	registerSuite({
		...
		"custom element created": function () {
			return this.remote
				.execute("return document.getElementById('myCustomElement')._constructorCalled").then(function (value) {
					assert(value, "custom element created");
				})
				.execute("return document.getElementById('myCustomElement')._connectedCallbackCalled").then(function (value) {
