 ...
 */
define(["./attr", "./template"], function (attr, template) {
					...
					default:
						if (/^on-/.test(item.name)) {
							...
							if (propName && typeof elem[propName] !== "string" &&
								...
								// This attribute corresponds to a property in tag, and the value specified is a
								// literal like vertical="false", so convert to correct type.
